    ...
    <ModalWrapper isOpen={isOpen} onClose={onClose} title="Add Game to Library" maxWidth="max-w-xl">
      <div className="flex flex-col h-[500px]">
        ...
        <div className="flex-1 overflow-y-auto custom-scrollbar space-y-3">
          ...
          {results.map((game) => (
            <div key={game.id} className="flex items-center gap-4 p-3 rounded-xl bg-white/5 hover:bg-white/10 border border-transparent hover:border-white/10 transition-colors">
              <img src={game.cover} alt="" className="w-12 h-16 object-cover rounded-md bg-plasma-slate" />
