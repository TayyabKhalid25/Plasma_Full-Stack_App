/**
 * Zero-Cloud Vault Utility for Client
 * 
 * USAGE:
...
async function encrypt() {
    ...
    const password = await askPassword('Enter Team Password to ENCRYPT .env.local: ');
    if (!password) {
    ...
    console.log('\nSUCCESS: .env.local has been encrypted into secrets.enc');
...
async function decrypt() {
    ...
    const password = await askPassword('Enter Team Password to DECRYPT secrets.enc: ');
    ...
    try {
        ...
        console.log('\nSUCCESS: secrets.enc has been decrypted into .env.local');
